...
namespace WFB
{
	...
	void Hud::Draw()
	{
		...
		int versionTextSize = MeasureText("V 1.0", versionFontSize);
		DrawText("V 1.0", GetScreenWidth() - (versionTextSize * 2), GetScreenHeight() - versionTextSize, versionFontSize, BLACK);
